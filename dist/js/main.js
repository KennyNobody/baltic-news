...
var initMenu = function initMenu() {
  ...
  var padding = document.querySelector('.player').clientHeight;
...
document.addEventListener('DOMContentLoaded', function () {
  (function inputFile() {
    var inputBlock = document.querySelectorAll('.file');
    ...
    function initFileInput(inputBlock) {
      var textBlock = inputBlock.querySelector('.file__text');
      var fieldBlock = inputBlock.querySelector('.file__field');
      fieldBlock.addEventListener('change', function () {
        updateImageDisplay();
      });

      function updateImageDisplay() {
        var currentFiles = fieldBlock.files;
